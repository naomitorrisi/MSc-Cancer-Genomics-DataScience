...
# BiocManager::install("DESeq2", "EnhancedVolcano", "AnnotationDbi", "org.Hs.eg.db")
...
scale.dat <- t(scale(t(assay(vsd)[de.sign.genes,]))) # subseting the vsd matrix to include only the de.sign.genes and scaling it by row so that we plot on the heatmap
